          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'ForgeAI will combine your goal, body context, equipment, and schedule into a practical workout.',
                ...
                Row(
                  children: [
                    _buildStat('INPUTS', '5', AppColors.sportOrange),
                    ...
                    const SizedBox(width: AppSpacing.lg),
                    _buildStat('OUTPUT', 'Plan', AppColors.cardWhite),
                  ],
                ),
              ],
            ),
